...
public class Maze02SolutionSearchTests {
    @Test
    public void should_test_solutions_search_for_maze_02_with_1_life() {
        // Arrange
    ...
    @Test
    public void should_test_solutions_search_for_maze_02_with_6_lifes() {
        // Arrange
        Maze maze = new Maze02();
        ...
        for (Node node : tree.solutions) {
            ...
            // Assert
            assertThat(isSolution).isTrue();
            assertThat(node.lifes).isEqualTo(1);
        }
    }

    @Test
    public void should_test_solutions_search_for_maze_02_with_infinity_life() {
        // Arrange
        Maze maze = new Maze02();
